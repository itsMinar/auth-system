...
router.post(
  "/logout-all",
  authenticate,
  (req, res, next) => controller.logoutAll(req as AuthenticatedRequest, res, next)
);

router.post(
  "/resend-verification",
  authenticate,
  (req, res, next) => controller.resendVerification(req as AuthenticatedRequest, res, next)
);
...
router.get(
  "/sessions",
  authenticate,
  (req, res, next) => controller.getSessions(req as AuthenticatedRequest, res, next)
);

router.delete(
  "/sessions/:sessionId",
  authenticate,
  (req, res, next) => controller.revokeSession(req as AuthenticatedRequest, res, next)
);
